...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>Fisk </span>Meal.</a>
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            <div class="image">
               <img src="images/ajigallina.png" alt="">
            </div>
            <div class="content">
               <h3 style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Ají de Gallina</h3>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/lomores.png" alt="">
            </div>
            <div class="content">
               <h3 style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Lomo Saltado</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/asadores.png" alt="">
            </div>
            <div class="content">
               <h3 style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Asado de Res</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
          ...
          if (!myLandbot) {
            ...
            s.addEventListener('load', function() {
              var myLandbot = new Landbot.Livechat({
                configUrl: 'https://storage.googleapis.com/landbot.online/v3/H-1740996-YE90F7QLSZUC5ZF2/index.json',
              });
            });
